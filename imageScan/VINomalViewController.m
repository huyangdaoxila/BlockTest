...
//            [_backButton setAttributes:@{kWButtonImageNomal:@"library.bundle/viphoto_cancel"} withClickBlock:^(WButton *reuseBtn) {
//                UIViewController *vc = [DXLBaseUtils viewControllerForView:reuseBtn];
//                [vc dismissViewControllerAnimated:YES completion:nil];
//            }];
            [_backButton setBackgroundImage:[UIImage imageNamed:@"viphoto_cancel"] forState:UIControlStateNormal];
    ...
    if (self.showBottomView) {
        [self bottomViewSetting:^(VIBottomView *bottomView) {
            ...
            _customTextView.textColor = [UIColor blackColor];//[DXLBaseUtils getColor:@"999999"];
...
//    [textViewstr addAttribute:NSForegroundColorAttributeName value:[DXLBaseUtils getColor:@"999999"] range:NSMakeRange(0, textViewstr.length)];
    [textViewstr addAttribute:NSForegroundColorAttributeName value:[UIColor blackColor] range:NSMakeRange(0, textViewstr.length)];
